...
class UsdToUrdfTestCase(unittest.TestCase):
    ...
    def test_usd_to_urdf(self):
        input_usd_path = os.path.join(self.resource_path, "input", "full_house", "full_house.usda")
        ...
        output_urdf_path = os.path.join(self.resource_path, "output", "test_usd_to_urdf", "full_house.urdf")
