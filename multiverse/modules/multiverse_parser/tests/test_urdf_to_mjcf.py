...
class UrdfToMjcfTestCase(unittest.TestCase):
    ...
    def test_urdf_to_mjcf_1(self):
        ...
        output_urdf_path = os.path.join(self.resource_path, "output", "test_urdf_importer", "to_mjcf", "tiago_dual.xml")
        exporter = MjcfExporter(file_path=output_urdf_path,
                                factory=factory)
        exporter.build()
        exporter.export()

        output_usd_path = os.path.join(self.resource_path, "output", "test_urdf_importer", "to_mjcf", "tiago_dual.usda")
