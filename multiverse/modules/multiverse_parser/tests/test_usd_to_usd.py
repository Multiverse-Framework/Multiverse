...
class UsdToUsdTestCase(unittest.TestCase):
    ...
    def test_usd_to_usd(self):
        input_usd_path = os.path.join(self.resource_path, "input", "ApartmentECAI", "ApartmentECAI2024.usda")
        ...
        output_usd_path = os.path.join(self.resource_path, "output", "test_usd_to_usd", "ApartmentECAI", "ApartmentECAI.usda")
