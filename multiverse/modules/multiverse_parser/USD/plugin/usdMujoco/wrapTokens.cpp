...
void wrapUsdMujocoTokens()
{
    boost::python::class_<UsdMujocoTokensType, boost::noncopyable>
        cls("Tokens", boost::python::no_init);
    
    _AddToken(cls, "Mujoco", UsdMujocoTokens->Mujoco);
    _AddToken(cls, "mjModel", UsdMujocoTokens->mjModel);
    _AddToken(cls, "MujocoOptionAPI", UsdMujocoTokens->MujocoOptionAPI);
    _AddToken(cls, "mjTimeStep", UsdMujocoTokens->mjTimeStep);
