...
def semantic_reporting(in_ABox_usd_file: str, in_TBox_Usd_file: str, out_ABox_usd_file: str) -> None:
...
def main():
    ...
    semantic_reporting(args.in_usd, args.in_TBox_usd, args.out_ABox_usd)
