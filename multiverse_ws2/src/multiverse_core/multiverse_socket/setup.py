...
submodule2 = os.path.join(submodule1, "multiverse_nodes")
submodule3 = os.path.join(submodule1, "multiverse_publishers")
submodule4 = os.path.join(submodule1, "multiverse_subscribers")
submodule5 = os.path.join(submodule1, "multiverse_services")

setuptools.setup(
    name=package_name,
    version="0.0.0",
    packages=[package_name, submodule1, submodule2, submodule3, submodule4, submodule5],
    package_dir={package_name: os.path.join('src', package_name),
                 ...
                 submodule5: os.path.join('src', submodule5)},
