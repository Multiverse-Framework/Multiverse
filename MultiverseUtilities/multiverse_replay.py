...
if __name__ == '__main__':
    ...
    multiverse_meta_data = MultiverseMetaData(
        ...
        simulation_name="multiverse_replay",
        length_unit="m",
        angle_unit="rad",
        mass_unit="kg",
        time_unit="s",
    ...
    multiverse_logger = MultiverseReplay(server_port=args.server_port, port=args.port, multiverse_meta_data=multiverse_meta_data)
