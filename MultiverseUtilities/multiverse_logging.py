...
if __name__ == "__main__":
    ...
    parser.add_argument("--server_port", type=str, required=False, default="7000", help="Port number")
    ...
    parser.add_argument("--time_step", type=float, required=False, default=0.05, help="Time step")
    ...
    multiverse_logger = MultiverseLogger(server_port=args.server_port,
                                         port=args.port,
