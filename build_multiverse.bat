...
copy /y "%MULTIVERSE_DIR%\build\vcpkg_installed\x64-windows\bin\boost_atomic-vc143-mt-x64-1_84.dll" "%MULTIVERSE_DIR%\bin"
copy /y "%MULTIVERSE_DIR%\build\vcpkg_installed\x64-windows\bin\boost_filesystem-vc143-mt-x64-1_84.dll" "%MULTIVERSE_DIR%\bin"
copy /y "%MULTIVERSE_DIR%\build\vcpkg_installed\x64-windows\bin\boost_system-vc143-mt-x64-1_84.dll" "%MULTIVERSE_DIR%\bin"
